        ...
        dbc.Col([
            dbc.Card([
                ...
                dbc.CardBody([
                    ...
                    dbc.Input(id="input-user-name", type="text", placeholder="Digite seu nome..."),
                    dbc.Button("Salvar Perfil", id="btn-save-profile", color="primary", className="mt-3"),
                    dbc.Alert(id="profile-save-status", color="success", is_open=False, duration=4000, className="mt-3")
                ])
            ])
        ], md=6),
        dbc.Col([
             dbc.Card([
                ...
                dbc.CardBody([
                    html.Pre(id="stored-data-display", style={"whiteSpace": "pre-wrap"})
                ])
            ])
        ], md=6)
    ])
