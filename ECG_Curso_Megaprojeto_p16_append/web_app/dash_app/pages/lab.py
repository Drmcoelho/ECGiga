...
controls = dbc.Card([
    ...
    dbc.CardBody([
        ...
        dcc.Slider(id='hr-slider', min=30, max=150, step=5, value=60, marks={30:'30', 60:'60', 90:'90', 120:'120', 150:'150'}),
        html.Hr(),
        dbc.Label("Potássio [K+] (mEq/L)"),
        dcc.Slider(id='k-slider', min=2.5, max=8.0, step=0.5, value=4.5, marks={2.5:'2.5', 4.5:'4.5', 6.0:'6.0', 8.0:'8.0'}),
        html.Hr(),
        dbc.Label("Cálcio [Ca2+] (mg/dL) - Afeta QT"),
        dcc.Slider(id='ca-slider', min=7.0, max=13.0, step=0.5, value=9.5, marks={7:'7', 9.5:'9.5', 11:'11', 13:'13'}),
        html.Hr(),
        dbc.Label("Intervalo PR (ms)"),
        dcc.Slider(id='pr-slider', min=100, max=300, step=10, value=160, marks={100:'100', 200:'200', 300:'300'}),
        html.Hr(),
        dbc.Label("Duração QRS (ms)"),
        dcc.Slider(id='qrs-slider', min=70, max=180, step=10, value=90, marks={70:'70', 120:'120', 180:'180'}),
    ])
], className="mb-3")

layout = dbc.Container([
    html.H1("Laboratório Interativo de Fisiologia do ECG"),
    html.P("Use os sliders para alterar os parâmetros e observar o impacto na forma de onda do ECG em tempo real."),
    dbc.Row([
        dbc.Col(controls, md=4),
        dbc.Col([
            dcc.Graph(id='ecg-graph'),
            dbc.Alert(id='feedback-panel', color="info")
        ], md=8)
    ])
], fluid=True)
