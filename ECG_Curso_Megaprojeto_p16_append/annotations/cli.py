...
def validate(annotations_json: str = typer.Argument(..., help="annotations.json"),
...
@app.command("compare")
def compare(pred_json: str = typer.Argument(..., help="annotations.json do aluno"),
    ...
    for lab in labels:
        ...
        report["per_label"][lab] = {"TP":tp,"FP":fp,"FN":fn,"precision":prec,"recall":rec,"F1":f1}
        all_f1.append(f1)
...
@app.command("overlay")
def overlay(image_path: str = typer.Argument(..., help="PNG/JPG do caso"),
