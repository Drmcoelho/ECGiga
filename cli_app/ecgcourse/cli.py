...
report = typer.Typer(help="Comandos para exportar e manipular laudos")
...
rhythm = typer.Typer(help="Comandos para análise de ritmo")
...
precordials = typer.Typer(help="Comandos para análise das derivações precordiais")
...
checklist = typer.Typer(help="Comandos para checklists clínicos")
